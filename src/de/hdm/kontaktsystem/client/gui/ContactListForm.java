...
public class ContactListForm extends VerticalPanel {
	...
	Button deleteButton = new Button("Kontakt aus einer Liste lÃ¶schen");
	...
	public void onLoad() {
		...
		// dem ContactVector hinzugefï¿½gt werden.
		...
		/**
		 * Panel fÃ¼r Anordnung der Button
		 */
		...
		/*
		 * CheckBoxen fÃ¼r das Teilen einer ContactList Form
...
//			} else {
	...
	/**
	 * ClickHandler zum Teilen der KontaktListe mit dem ausgewÃ¤hlten User
	 * @author Kim-Ly
	 *
	 */
	...
	/**
	 * Callback Methode fÃ¼r das Teilen von Kontaktliste
	 * @author Kim-Ly
	 *
	 */
	...
	/**
	 * ClickHandler zum LÃ¶schen von Kontakten aus Kontaktliste
	 * @author Kim-Ly
	 *
	 */
	...
	implements AsyncCallback<ContactList> {
		...
		public void onSuccess(ContactList result) {
			if (result != null) {
				...
				Window.alert("Kontakt wurde erfolgreich aus der Liste gelÃ¶scht");
			}
		}
	}
	...
	private class deleteClClickHandler implements ClickHandler {
		...
		implements AsyncCallback<ContactList> {
			...
			@Override
			public void onFailure(Throwable caught) {
				Window.alert("LÃ¶schen der Kontaktliste fehlgeschlagen");
			}
