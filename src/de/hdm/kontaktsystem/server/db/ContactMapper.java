 ...
 * auf eine relationale Datenbank ab. Dazu werden Methoden zum Erzeugen, Suchen, Ã„ndern und 
 * LÃ¶schen von Objekten zur VerfÃ¼gung gestellt. Es kÃ¶nnen sowohl Objekte in Datenbank-Strukturen, 
 * als auch Datenbank-Strukturen in Objekte Ã¼berfÃ¼hrt werden.
 * 
 * @author Katalin
 *
 */
public class ContactMapper {
	 ...
	 * nur einmal fÃ¼r alle Instanzen der Klasse vorhanden.
	 */
	...
	/**
	 * Mapper-Methode zur RÃ¼ckgabe aller Kontakte eines bestimmten Users
	 * 
	 * @param user_id
	 * @return
	 */
	...
	public Vector<Contact> findAllContactsByUser(double user_id) {
		...
		try {
			...
			while (rs.next()) {
				...
				//HinzufÃ¼gen zum Ergebnisvektor
	...
	/**
	 * Mapper-Methode um einen Kontakt Ã¼ber die ID zu suchen.
	 * 
	 * @param id
	 * @return
	 */
