...
public class ContactMapper {
	...
	/**
	 *  Mapper-Methoden um Kontakte zu l�schen
	 * @param contact
	 */
	public void deleteContact (Contact contact) {
		...
		try {
			...
			PropertyValueMapper.propertyValueMapper().deleteBy(contact); //TODO: abkl�ren ob der richtige?
	...
	/**
	 * Mapper-Methode um Kontakte mit Hilfe der ID zu l�schen
	 * @param id
	 */
	...
	/**
	 * Mapper-Methode um alle Kontakte eines Users zu l�schen
	 */

	public void deleteAllContactsByUser(int user_id) {
		//TODO:get all contacts und dann durchgehen und l�schen
