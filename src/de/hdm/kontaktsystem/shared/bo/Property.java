 ...
 * diese können einem Nutzer, dessen Kontakten oder Kontaktlisten zugeordnet
 * werden.
 * </p>
 * <p>
 * Ein Nutzer (User Klasse) ist dabei entweder der Besitzer (owner) der
 * Eigenschaft oder ein Teilhaber dieser (participant).
 * </p>
 * 
...
public class Property extends BusinessObject {
	...
	/**
	 * Bei der Erzeugung einer neuen Eigenschaftsinstanz muss nicht zwingend eine
	 * Eigenschaftsausprägung (PropertyValue Instanz) erzeugt werden
	 */
	 ...
	 * PropertyValue-Objekte. Die Gleichheit wird in diesem Beispiel auf eine
	 * gleiche Identität beschränkt.
	 * </p>
	 * 
	 */
	...
	public boolean equals(Object o) {
		/*
		 * 
		 * Abfragen, ob ein Objekt ungl. NULL ist und ob ein Objekt gecastet werden kann
		 */
	...
	/**
	 * Der Hash-Code liefert zu jedem Objekt eine eindeutige Integerzahl, mit der
	 * das Objekt identifiziert werden kann. Der Hash-Wert entspricht hier
	 * einfachheitshalber der ID des Objekts. Dies überschreibt die Methode
	 * hashCode() der Klasse Object.
	 * 
	 */
	...
	/**
	 * Erzeugen einer textuellen Darstellung der jeweiligen Eigenschaft. Dies
